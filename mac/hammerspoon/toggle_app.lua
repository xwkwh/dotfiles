...
hs.hotkey.bind(hyper, "p", function() toggleApp("com.postmanlabs.mac") end)
hs.hotkey.bind(hyper, "0", function() toggleApp("com.netease.163music") end)
hs.hotkey.bind(hyper, "c", function() toggleApp("com.xk72.Charles") end)
hs.hotkey.bind(hyper, "d", function() toggleApp("com.readdle.PDFExpert-Mac") end)
...
-- hs.hotkey.bind(hyper2, "m", function() toggleApp("com.netease.macmail") end)
